...
namespace pybind_vectorize {
    ...
    //! Vectorized `flux` method: single-wavelength starry_beta
    template <typename T>
    ...
    //! Vectorized `flux` method: spectral starry_beta
    template <typename T>
    typename std::enable_if<std::is_base_of<Eigen::EigenBase<Row<T>>,
                                            Row<T>>::value, py::object>::type
    flux(maps::Map<T> &map, py::array_t<double>& theta, py::array_t<double>& xo,
    ...
    //! Vectorized `evaluate` method: single-wavelength starry_beta
    template <typename T>
    typename std::enable_if<!std::is_base_of<Eigen::EigenBase<Row<T>>,
                                             Row<T>>::value, py::object>::type
    ...
    //! Vectorized `evaluate` method: spectral starry_beta
    template <typename T>
    typename std::enable_if<std::is_base_of<Eigen::EigenBase<Row<T>>,
                                            Row<T>>::value, py::object>::type
    evaluate(maps::Map<T> &map, py::array_t<double>& theta,
