...
TODO: Add the `add_gaussian` method to spectral starry_beta.
...
namespace pybind_interface {
    ...
    /**
    Add type-specific features to the Map class: single-wavelength starry_beta.
    ...
    */
    ...
    addMapExtras(py::class_<maps::Map<T>>& Map) {
        ...
        Map
            ...
            .def("show", [](maps::Map<T> &map, std::string cmap, int res) {
                py::object show =
                    py::module::import("starry_beta.maps").attr("show");
                Matrix<double> I;
                I.resize(res, res);
                Vector<Scalar<T>> x;
            ...
            .def("animate", [](maps::Map<T> &map, std::string cmap, int res,
                ...
                py::object animate =
                    py::module::import("starry_beta.maps").attr("animate");
             ...
             .def("load_image", [](maps::Map<T> &map, std::string& image,
                                   int lmax) {
                 py::object load_map =
                    py::module::import("starry_beta.maps").attr("load_map");
                 if (lmax == -1)
                    lmax = map.lmax;
             ...
             .def("add_gaussian", [](maps::Map<T> &map, const double& sigma,
                ...
                py::object gaussian =
                    py::module::import("starry_beta.maps").attr("gaussian");
                if (lmax == -1)
                   lmax = map.lmax;
                Vector<double> y = amp *
    ...
    /**
    Add type-specific features to the Map class: spectral starry_beta.
    ...
    */
    ...
    /**
    Add type-specific features to the Body class: single-wavelength starry_beta.
    ...
    */
    ...
    /**
    Add type-specific features to the Body class: spectral starry_beta.
    ...
    */
    ...
    /**
    Add type-specific features to the System class: single-wavelength starry_beta.
    ...
    */
    ...
    /**
    Add type-specific features to the System class: spectral starry_beta.
